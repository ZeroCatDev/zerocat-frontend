<template><v-layout>
    ...
    <v-app-bar color="transparent" flat>
      ...
      <div class="d-flex flex-1-1-0 pe-3">
        <v-btn append-icon="mdi-chevron-right" class="ms-auto text-none" slim text="账户" to="/account" />
      </div>
    </v-app-bar>
    ...
    <v-main :min-height="$vuetify.display.mdAndUp ? 1000 : 550">
      <v-container class="h-100 d-flex align-center justify-center">
        <div class="w-100 w-md-50 text-center" >
          <v-chip border="thin opacity-25" color="surface" variant="flat" target="_blank" href="https://www.rainyun.com/wuyuan_?s=zerocat" append-icon="mdi-arrow-right">
            <span class="hidden-sm-and-down">ZeroCat使用</span>
            <span class="hidden-md-and-up">由</span>雨云作为基础设施
          </v-chip>
          ...
          <div class="d-flex ga-4 justify-center">
            <v-btn class="text-none" color="primary" flat to="/projects" rounded="lg" text="浏览作品" />

            <v-btn append-icon="mdi-chevron-right" class="text-none" flat rounded="lg" text="了解更多" />
          </div>
        </div>
  ...
  <v-container class="pa-md-12 pa-sm-6">
    <v-row align="center">
      <v-col class="text-center text-lg-left pa-6 pa-md-12" cols="12" lg="6">
        <v-responsive class="mx-auto" max-width="500">
          ...
          <v-btn class="mr-4 text-none" color="primary" size="small" text="Github" variant="flat"
            href="https://github.com/zerocatdev" target="_blank" />

          <v-btn append-icon="mdi-arrow-right" class="text-none" size="small" text="了解更多" variant="text" />
        </v-responsive>
      </v-col>

      <v-col cols="12" lg="6">
        <v-img cover min-height="440" position="left" :rounded="$vuetify.display.smAndDown ? true : 'e-lg'"
  ...
  <v-container class="pa-md-12 pa-sm-6">
    <v-card class="pa-6 pa-md-12" :image="src" rounded="xl">
      ...
      <v-list-item class="px-0" subtitle="开发者" title="吾家九尾" />
    </v-card> </v-container><v-responsive min-height="500">
    <v-container class="pa-6 pa-md-12  text-center  flex-column">
      <h1 class="font-weight-bold mb-4 text-h5 text-sm-h4">受到用户喜爱</h1>
    ...
    <v-row>
      <v-col cols="12" lg="4" md="12">
        ...
        <p class="mt-4 text-body-1 text-medium-emphasis">
          <v-chip border="thin opacity-25" color="surface" variant="flat" href="https://langs.ink/article/houlangs/">
           这是厚浪开发组的简介↓
          </v-chip><br/>
          <br/>
          这是一支极具创新能力的团队，我们朝气蓬勃，充满活力，热爱代码。<br/>

我们善于使用最新的技术，我们的与老一代云服务提供商——雨云有着密切的沟通，与他们一同助力青少年上云<br/>
<br/>
<v-alert
      border="start"
    ...
    长江后浪推前浪<br/>浮世新人换旧人
      ...
      <v-col cols="12" lg="8" md="12">
        <v-row justify="center">
          <v-col v-for="(item, i) in teams" :key="i" cols="12" sm="6">
            <v-list-item class="px-0" :subtitle="item.subtitle" :title="item.title" :href="item.link">
              <template #prepend>
  ...
  </v-container> <v-container class="pa-md-12 pa-sm-6 bg-primary text-center" fluid>
    <h1 class="font-weight-bold mb-4 text-h5 text-sm-h5">
      长江后浪推前浪 浮世新人换旧人
  ...
  data() {
    return {
      teams: [
        ...
        {
          title: '加入我们',
          subtitle: '虽然Jacopo说不招人，但你依然可以投个自我介绍试试，也许呢？',
          avatar: 'https://langs.ink/jacopo-logo.webp',
