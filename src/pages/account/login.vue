      ...
      <VCardText>
        <VForm>
          <VRow>
            <!-- email -->
            <VCol cols="12">
              <VTextField label="邮箱" type="text" v-model='username' variant="outlined" :rules="emailRules"></VTextField>
              <VTextField label="密码" v-model='password' variant="outlined" :rules="usernameRules"
            ...
            <VCol cols="12">
              ...
              <v-btn class="text-none" color="primary" rounded="xl" text="登录" variant="flat" size="large" @click="login" append-icon="mdi-arrow-right"></v-btn> <!-- login button -->

            </VCol>
            <VCol cols="12">


<v-btn class="text-none" color="white" rounded="xl" text="注册" variant="text" size="large" append-icon="mdi-arrow-right" to="/account/register"></v-btn> <!-- login button -->
